  ...
  tx_t p6 = "";
    ...
    if (strcmp(glx,"AS") == 0) {
        ...
        if (strcmp(glx2,"RESPONSE") == 0) {
            ...
            p6 = _second(dot_pair);
            return plant_list_make ( 2 , plant_list_make ( 6 , "type" , "respond_stmt" , "content" , expr , "req" , clv ) , p6 );
        }
    }
...
tx_t parse_closure(PlantArray* tokens, long pos, PlantArray* rtab, tx_t emode) {
  ...
  tx_t ep = "";
    ...
    if (strcmp(blx,"(") == 0) {
        ...
        blx2 = tok_lex(btok2);
        if (strcmp(blx2,"CREATE") == 0 || strcmp(blx2,"SHOW") == 0 || strcmp(blx2,"GIVE") == 0 || strcmp(blx2,"SET") == 0 || strcmp(blx2,"LET") == 0 || strcmp(blx2,"IF") == 0 || strcmp(blx2,"SEASON") == 0 || strcmp(blx2,"REAP") == 0 || strcmp(blx2,"PUT") == 0 || strcmp(blx2,"TAKE") == 0 || strcmp(blx2,"BREAK") == 0 || strcmp(blx2,"CONTINUE") == 0 || strcmp(blx2,"SORT") == 0 || strcmp(blx2,"SHAKE") == 0 || strcmp(blx2,"BRAID") == 0 || strcmp(blx2,"LINK") == 0 || strcmp(blx2,"HARVEST") == 0 || strcmp(blx2,"LISTEN") == 0 || strcmp(blx2,"CONST") == 0 || strcmp(blx2,"ROOT") == 0 || strcmp(blx2,"ROOT_SCOPE") == 0 || strcmp(blx2,"NOW") == 0 || strcmp(blx2,"ANALYZE") == 0 || strcmp(blx2,"TYPEOF") == 0 || strcmp(blx2,"FREE") == 0 || strcmp(blx2,"ARC") == 0 || strcmp(blx2,"FAST") == 0) {
            body_kind = "block";
            tx_t clv = "";
...
tx_t generate_node(tx_t node, long indent, PlantArray* sigs, PlantArray* subst, PlantArray* clmap, tx_t actx, PlantArray* nums, PlantArray* stvars, PlantArray* evars, tx_t rty, tx_t mexit, tx_t wexit) {
  ...
  tx_t ename = "";
    ...
    if (strcmp(ntype,"respond_stmt") == 0) {
        ...
        return _cat(_cat(_cat(_cat(_cat(isel, "  plant_net_respond("), rs_req), ", "), rsb), ");\n");
    }

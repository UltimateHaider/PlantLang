...
**Pure Native 🚀** · Self-Hosting Compiler & Build System · v0.46.4
...
- **Self-hosting** — the entire compiler pipeline (lexer, parser, C codegen, CLI)
  is written in PlantLang under `src/plantc/`
...
gcc -w -O0 -I runtime/c out.c runtime/c/plant_runtime.c -o hello
./hello
```
...
| [CHANGELOG.md](CHANGELOG.md) | Full version history through v0.46.4 |

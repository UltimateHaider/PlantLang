...
**Pure Native 🚀** · Self-Hosting Compiler & Build System · v0.47.1
...
./bin/Chloroplast --version     # Chloroplast 0.47.1 (pure native)
```
...
| [CHANGELOG.md](CHANGELOG.md) | Full version history through v0.47.1 |

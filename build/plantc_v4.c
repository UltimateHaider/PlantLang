...
tx_t parse_if_stmt(PlantArray* tokens, long pos, tx_t clv);
tx_t parse_season_stmt(PlantArray* tokens, long pos, tx_t clv);
tx_t parse_cycle_stmt(PlantArray* tokens, long pos, tx_t clv);
tx_t parse_throw_stmt(PlantArray* tokens, long pos);
tx_t parse_stop_if_stmt(PlantArray* tokens, long pos);
tx_t parse_weather_stmt(PlantArray* tokens, long pos, tx_t clv);
tx_t parse_statement(PlantArray* tokens, long pos, tx_t clv);
...
tx_t parse_declaration(PlantArray* tokens, long pos, tx_t clv);
    ...
    while (i < n) {
        ...
        if (strcmp(ch,"\"") == 0) {
            if (plant_list_get(si,  2 ) == 1) {
                tokens = plant_list_add(tokens, plant_list_make ( 2 , "INTERP" , plant_list_get(si,  0 ) ));
            }
        }
        if (strcmp(ch,"\"") == 0) {
            if (plant_list_get(si,  2 ) != 1) {
                tokens = plant_list_add(tokens, plant_list_make ( 2 , "STRING" , plant_list_get(si,  0 ) ));
            }
        }
        if (strcmp(ch,"\"") == 0) {
        ...
        if (strcmp(ch,"0") >= 0 && strcmp(ch,"9") <= 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),"\\") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "DEPTH" , plant_list_get(si,  0 ) ));
        }
        if (strcmp(ch,"0") >= 0 && strcmp(ch,"9") <= 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),"\\") == 0) {
        ...
        if (strcmp(ch,"0") >= 0 && strcmp(ch,"9") <= 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "NUMBER" , plant_list_get(si,  0 ) ));
        }
        if (strcmp(ch,"0") >= 0 && strcmp(ch,"9") <= 0) {
            i = plant_list_get(si,  1 );
        }
        ...
        if (ok) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , tok_ty , plant_list_get(si,  0 ) ));
        }
        if (ok) {
            i = plant_list_get(si,  1 );
        }
        ...
        if (strcmp(ch,".") == 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),".") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "DOT_DOT" , ".." ));
            i = i+2;
                      continue;
        }
        if (strcmp(ch,"-") == 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),">") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "ARROW" , "->" ));
            i = i+2;
                      continue;
        }
        if (strcmp(ch,">") == 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),"=") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "GREATER" , ">=" ));
            i = i+2;
                      continue;
        }
        if (strcmp(ch,"<") == 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),"=") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "LESS" , "<=" ));
            i = i+2;
                      continue;
        }
        if (strcmp(ch,"=") == 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),"=") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "EQUAL" , "==" ));
            i = i+2;
                      continue;
        }
        if (strcmp(ch,"!") == 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),"=") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "BANG" , "!=" ));
            i = i+2;
                      continue;
        }
        if (strcmp(ch,"*") == 0 && i + 1 < n && strcmp(char_at ( src , i + 1 ),"*") == 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , "**" , "**" ));
            i = i+2;
                      continue;
        }
        tok_ty = char_type(ch);
        if (strcmp(tok_ty,"") != 0) {
            tokens = plant_list_add(tokens, plant_list_make ( 2 , tok_ty , ch ));
        }
        if (strcmp(tok_ty,"") != 0) {
            i = i+1;
        }
        ...
        tokens = plant_list_add(tokens, plant_list_make ( 2 , "ERROR" , ch ));
        i = i+1;
    }
...
tx_t parse_closure(PlantArray* tokens, long pos) {
  ...
  tx_t ep = "";
    ...
    if (strcmp(blx,"(") == 0) {
        ...
        blx2 = tok_lex(btok2);
        if (strcmp(blx2,"CREATE") == 0 || strcmp(blx2,"SHOW") == 0 || strcmp(blx2,"GIVE") == 0 || strcmp(blx2,"SET") == 0 || strcmp(blx2,"LET") == 0 || strcmp(blx2,"IF") == 0 || strcmp(blx2,"SEASON") == 0 || strcmp(blx2,"REAP") == 0 || strcmp(blx2,"PUT") == 0 || strcmp(blx2,"TAKE") == 0 || strcmp(blx2,"BREAK") == 0 || strcmp(blx2,"CONTINUE") == 0 || strcmp(blx2,"SORT") == 0 || strcmp(blx2,"SHAKE") == 0 || strcmp(blx2,"BRAID") == 0 || strcmp(blx2,"LINK") == 0 || strcmp(blx2,"HARVEST") == 0 || strcmp(blx2,"LISTEN") == 0) {
            body_kind = "block";
            tx_t clv = "";
            ...
            while (1) {
                ...
                d_pair = parse_statement(tokens, p6, clv);
...
tx_t parse_if_stmt(PlantArray* tokens, long pos, tx_t clv) {
  ...
  tx_t sty = "";
    ...
    while (1) {
        ...
        stmt_pair = parse_statement(tokens, p4, clv);
...
tx_t parse_weather_stmt(PlantArray* tokens, long pos, tx_t clv) {
  ...
  tx_t sty = "";
    ...
    while (1) {
        ...
        stmt_pair = parse_statement(tokens, p2, clv);
        tx_t stmt = plant_list_get(stmt_pair,  0 );
...
tx_t parse_statement(PlantArray* tokens, long pos, tx_t clv) {
  ...
  tx_t nx3_ty = "";
    ...
    if (strcmp(lx,"IF") == 0) {
        r = parse_if_stmt(tokens, pos, clv);
        return r;
    }
    if (strcmp(lx,"SEASON") == 0) {
        r = parse_season_stmt(tokens, pos, clv);
        return r;
    }
    if (strcmp(lx,"CYCLE") == 0) {
        r = parse_cycle_stmt(tokens, pos, clv);
        return r;
    }
    if (strcmp(lx,"WEATHER") == 0) {
        r = parse_weather_stmt(tokens, pos, clv);
        return r;
    }
...
tx_t parse_action_decl(PlantArray* tokens, long pos) {
  ...
  tx_t slv = "";
    ...
    while (1) {
        ...
        stmt_pair = parse_statement(tokens, p5, clv);
        tx_t stmt = plant_list_get(stmt_pair,  0 );
...
tx_t parse_declaration(PlantArray* tokens, long pos, tx_t clv) {
  ...
  tx_t nd2 = "";
    ...
    r = parse_statement(tokens, pos, clv);
    return r;
}
tx_t map_add(PlantArray* m, tx_t k, tx_t v) {
  tx_t me3 = "";
...
tx_t parse_program(PlantArray* tokens) {
  ...
  tx_t plv = "";
    ...
    while (1) {
        ...
        d_pair = parse_declaration(tokens, pos, clv);
        tx_t decl = plant_list_get(d_pair,  0 );
        pos2 = _second(d_pair);
        if (strcmp(decl,"") > 0) {
            dty = _map_get(decl, "type");
...
tx_t generate_node(tx_t node, long indent, PlantArray* sigs, PlantArray* subst, PlantArray* clmap, tx_t actx, PlantArray* nums, PlantArray* stvars, PlantArray* evars, tx_t rty, tx_t mexit, tx_t wexit) {
  ...
  tx_t ename = "";
    ...
    if (strcmp(ntype,"respond_stmt") == 0) {
        ...
        return _cat3(_cat4(isel, "  plant_net_respond(", rs_req, ", "), rsb, ");\n");
    }
...
tx_t generate_c(PlantArray* ast) {
  ...
  tx_t ns_code = "";
    ...
    return _cat3(_cat4(_cat4(_cat4(header, struct_code, ffi_topo, cltype_code), pro_code, cb_code, clfwd_code), "\n", cldef_code, "\n"), decl_code, stmt_code);
}
tx_t _cl_is_arg(tx_t arg) {
  tx_t pre = "";

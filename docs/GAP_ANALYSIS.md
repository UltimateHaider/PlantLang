...
- **FFI module bindings** (`plant_compat.h:125-129, 328, 384-393, 423-425`): `strings:` (13: LENGTH REPLACE SPLIT UPPER LOWER TRIM INCLUDES STARTS_WITH ENDS_WITH REVERSE REPEAT PAD PAD_LEFT), `fs:` (4: READ WRITE EXISTS APPEND), `math:` (19: LOG PI E SIGN CLAMP MIN MAX TAN ATAN COT ASIN ACOS ATAN2 SINH COSH TANH EXP EXPM1 LOG10 LOG2 LOG1P HYPOT) — used via `REAP … FROM module:FUNC, …`.

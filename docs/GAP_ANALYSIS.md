...
| `SPECIES name {f: T}` + `BLOOM` | S | **P** | v0.49.28: map-backed records (fields default "", obj.field read + .put write); no VAR syntax (D); ACTION members + SELF shipped v0.49.29; FROM inheritance shipped v0.49.30; ACTION members + SELF v0.49.31 |

# ═══════════════════════════════════════════════════════════════
# PlantLang — Chloroplast Pure Native Self-Hosting Toolchain (v0.49.58a)
#
# Targets:
...
dist: all self test ## Build versioned tarball + unpack/build/test validation
	...
	@cp $(RUNTIME_C) $(COMPAT) runtime/c/plant_runtime.h runtime/c/plant_report.h runtime/c/plant_types.h release/plantlang-$(VERSION)/runtime/c/
